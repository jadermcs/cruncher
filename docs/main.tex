...
is not possible (e.g. string to float) it return an error.
...
The alphanumerical types

Additionally, char can be converted to integer with his bits representation
directly.
